...
🔏 Edit your smart contract `FixedToken.sol` in `packages/hardhat/contracts`
...
🔲 Try making a `<Button/>` that calls `writeContracts.FixedToken.setPurpose("👋 Hello World")` to explore how your UI might work...
...
🔏 Edit or rename your smart contract `FixedToken.sol` in `packages/hardhat/contracts`
