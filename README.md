...
🔏 Edit your smart contract `TokenFactory.sol` in `packages/hardhat/contracts`
...
🔲 Try making a `<Button/>` that calls `writeContracts.TokenFactory.setPurpose("👋 Hello World")` to explore how your UI might work...
...
🔏 Edit or rename your smart contract `TokenFactory.sol` in `packages/hardhat/contracts`
