      ...
      */}
      <div style={{border:"1px solid #cccccc", padding:16, width:400, margin:"auto",marginTop:64}}>
        ...
        <div style={{margin:8}}>
          ...
          <Button onClick={()=>{
            ...
            tx( writeContracts.FixedToken.setPurpose(newPurpose) )
          }}>Set Purpose</Button>
        </div>
        ...
        <Address
            value={readContracts?readContracts.FixedToken.address:readContracts}
            ensProvider={mainnetProvider}
            fontSize={16}
        />
        ...
        <div style={{margin:8}}>
          <Button onClick={()=>{
            /* look how you call setPurpose on your contract: */
            tx( writeContracts.FixedToken.setPurpose("🍻 Cheers") )
        ...
        <div style={{margin:8}}>
          <Button onClick={()=>{
            ...
            */
            tx({
              to: writeContracts.FixedToken.address,
        ...
        <div style={{margin:8}}>
          <Button onClick={()=>{
            ...
            tx( writeContracts.FixedToken.setPurpose("💵 Paying for this one!",{
              value: parseEther("0.001")
            }))
        ...
        <div style={{margin:8}}>
          <Button onClick={()=>{
            ...
            tx({
              to: writeContracts.FixedToken.address,
              value: parseEther("0.001"),
              data: writeContracts.FixedToken.interface.encodeFunctionData("setPurpose(string)",["🤓 Whoa so 1337!"])
            });
            /* this should throw an error about "no fallback nor receive function" until you add it */
      ...
      {/*
        📑 Maybe display a list of events?
          (uncomment the event and emit line in FixedToken.sol! )
      */}
